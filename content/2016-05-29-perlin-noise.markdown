...
I used Perlin noise for the fog effect and title screen in [Under Construction](/blog/2016/05/25/under-construction-our-pico-8-game/).  I [tweeted about my efforts to speed it up](https://twitter.com/eevee/status/731633681735917568), and several people replied either confused about how Perlin noise works or not clear on what it actually is.
