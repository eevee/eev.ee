...
How far is it from Tim to Elliot Rodger?

How many Tims are we enabling by refusing to acknowledge that he already exists, that we're creating and nurturing Tims all the time?
