...
- **blog**: I wrote up the [Eevee mugshot set for Doom]({filename}/updates/2017-11-23-eevee-mugshot-set-for-doom.markdown) I made, as an inaugural post for the [release]({category}updates) category.
